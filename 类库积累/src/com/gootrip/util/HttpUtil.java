...
//region POST请求，字符串形式数据
     ...
     * @return html源代码
     */
    public static String sendPostUrl(String url, String param,String cookie, String charset) {
    ...
    public static String sendPostUrl(String url,String param, String charset){
        return sendPostUrl(url,param,"",charset);
    }
    /**
     * POST请求，字符串形式数据
     * @param url 请求地址
    ...
    public static String sendPostUrl(String url,String param){
        return sendPostUrl(url,param,"","utf-8");
    }
//endregion
...
//region POST请求，Map形式数据
     ...
     * @return html源代码
     */
    public static String sendPost(String url, Map<String, String> param,String cookie, String charset) {
